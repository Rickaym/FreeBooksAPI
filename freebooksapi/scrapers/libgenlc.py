...
class LibGenLc(GenLibRusEc):
    ...
    def _extract_attributes(self, cells) -> Dict[str, Any]:
      attrs: Dict[str, Any] = {"edition": None, "series": None, "isbn": None,"lang":"N/A"}
      ...
      if(len(cells) == 9):
        ...
        if(edition_and_series_container):
          edition_and_series_container = edition_and_series_container.find_all('a')
        ...
        if(t):
          ...
          attrs['id'] = edition_and_series_container[0].get("href").split('id=')[-1]
        isbn = []
